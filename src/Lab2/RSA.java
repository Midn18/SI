...
public class RSA {
    ...
    /**
     * Takes a string and converts each character to an ASCII decimal value Returns BigInteger
     */
    ...
    /**
     * Takes a BigInteger that is ciphered and converts it back to plain text returns a String
     */
    ...
    /**
     * 3. Compute Phi(n) (Euler's totient function) Phi(n) = (p-1)(q-1) BigIntegers are objects and must use methods for algebraic
     * operations
     */
    ...
    /**
     * Recursive implementation of Euclidian algorithm to find the greatest common denominator
     */
    ...
    /**
     * Recursive EXTENDED Euclidean algorithm, solves Bezout's identity (ax + by = gcd(a,b)) and finds the multiplicative inverse
     * which is the solution to ax ≡ 1 (mod m) returns [d, p, q] where d = gcd(a,b) and ap + bq = d
     */
